                      ...
                      <div className="h-auto overflow-hidden flex items-center justify-center shadow">
                        <div className="bg-gray-200 rounded py-16 px-24 m-0 flex flex-col items-center justify-center">
                          ...
                          <form onSubmit={onSubmitForm } className="mt-8 mb-4">
                            ...
                            <button className="bg-gray-500 hover:bg-gray-600 text-white font-bold w-full py-3" type="submit" >Log in </button>
                          </form>
                        </div>
                      </div>
                </div>
    ...
    <div class="mt-10 sm:mt-0">
      ...
      <div class="align-middle inline-block min-w-full shadow overflow-hidden bg-white shadow-dashboard px-8 pt-3 rounded-bl-lg rounded-br-lg">
        <table class="min-w-full">
          <thead>
            <tr>
              <th class="px-15 py-3 border-b-2 border-gray-300 text-left leading-4 text-black-500 tracking-wider">Departments</th>
    ...
    <div class="mt-10 sm:mt-0">
      ...
      <div class="align-middle inline-block min-w-full shadow overflow-hidden bg-white shadow-dashboard px-8 pt-3 rounded-bl-lg rounded-br-lg">
        <table class="min-w-full">
          <thead>
            <tr>
              <th class="px-15 py-3 border-b-2 border-gray-300 text-left leading-4 text-black-500 tracking-wider">Course</th>
    ...
    <div class="mt-10 sm:mt-0">
      ...
      <div class="align-middle inline-block min-w-full shadow overflow-hidden bg-white shadow-dashboard px-8 pt-3 rounded-bl-lg rounded-br-lg">
        <table class="min-w-full">
          <thead>
            <tr>
              <th class="px-15 py-3 border-b-4 border-gray-300 text-left leading-4 text-black-500 tracking-wider">Units</th>
    ...
    <div class="mt-10 sm:mt-0">
      ...
      <div class="align-middle inline-block min-w-full shadow overflow-hidden bg-white shadow-dashboard px-8 pt-3 rounded-bl-lg rounded-br-lg">
        <table class="min-w-full">
          <thead>
            <tr>
              <th class="px-15 py-3 border-b-2 border-gray-300 text-left leading-4 text-black-500 tracking-wider">Accounts</th>
    ...
    <div class="mt-10 sm:mt-0">
      ...
      <div class="align-middle inline-block min-w-full shadow overflow-hidden bg-white shadow-dashboard px-8 pt-3 rounded-bl-lg rounded-br-lg">
        <table class="min-w-full">
          <thead>
            <tr>
              <th class="px-15 py-3 border-b-2 border-gray-300 text-left leading-4 text-black-500 tracking-wider">Medicines</th>
        ...
        <table class="min-w-full">
          <thead>
            <tr>
              ...
              <th class="px-6 py-3 border-b-2 border-gray-300 text-left leading-4 text-black-500 tracking-wider">Generic Name</th>
              <th class="px-6 py-3 border-b-2 border-gray-300 text-left leading-4 text-black-500 tracking-wider">Brand Name</th>
    ...
    <div>
      ...
      <main>
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div className="px-4 py-8 sm:px-0">
            <div class="mt-10 sm:mt-0">
              <div class="md:grid md:grid-cols-3 md:gap-6 mb:9">
                <div class="md:col-span-1">
                  <div class="px-4 sm:px-0">
        ...
        <table class="min-w-full">
          <thead>
            <tr>
              ...
              <th class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-black-500 tracking-wider">First Name</th>
              <th class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-black-500 tracking-wider">Middle Name</th>
              <th class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-black-500 tracking-wider">Extension Name</th>
              <th class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-black-500 tracking-wider">Course</th>

            </tr>
          </thead>

          <td class="px-6 py-4 whitespace-no-wrap border-b text-black-900 border-gray-500 text-sm leading-5">101</td>
          <td class="px-6 py-4 whitespace-no-wrap border-b text-black-900 border-gray-500 text-sm leading-5">damilareanjorin1@gmail.com</td>
          <td class="px-6 py-4 whitespace-no-wrap border-b text-black-900 border-gray-500 text-sm leading-5">damilareanjorin1@gmail.com</td>
          <td class="px-6 py-4 whitespace-no-wrap border-b text-black-900 border-gray-500 text-sm leading-5">damilareanjorin1@gmail.com</td>
          <td class="px-6 py-4 whitespace-no-wrap border-b text-black-900 border-gray-500 text-sm leading-5">damilareanjorin1@gmail.com</td>
          ...
          <div class="shadow overflow-hidden sm:rounded-md">
            <div class="px-4 py-5 bg-white sm:p-6">
              <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-3">
                  <label for="last_name" class="block text-sm font-medium text-gray-700">Extension Name</label>
                  <input type="text" name="Middle_name" id="Middle_name" autocomplete="Middle-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-80 shadow-sm sm:text-sm border-gray-300 rounded-md bg-gray-200" />
                </div>
          ...
          <div class="shadow overflow-hidden sm:rounded-md">
            <div class="px-4 py-5 bg-white sm:p-6">
              <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-3">
                  <label for="Course" class="block text-sm font-medium text-gray-700">Position</label>
                  <select id="Course" name="Course" autocomplete="Course" class="mt-1 block w-auto py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm ">
                    <option>Student</option>
                    <option>Employee</option>
                ...
                <div class="col-span-6 sm:col-span-3">
                  <label for="Course" class="block text-sm font-medium text-gray-700">Units</label>
                  <select id="Course" name="Course" autocomplete="Course" class="mt-1 block w-auto py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm ">
                    <option>Student</option>
                    <option>Employee</option>
        ...
        <table class="min-w-full">
          <thead>
            <tr>
              ...
              <th class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-black-500 tracking-wider">Middle Name</th>
              <th class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-black-500 tracking-wider">Extension Name</th>
              <th class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-black-500 tracking-wider">Position</th>
              <th class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-black-500 tracking-wider">Units</th>
